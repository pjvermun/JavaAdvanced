...
@NamedQueries({
    @NamedQuery(
            name = "Opleiding.sorteerOpThema",
            query = "select o from Opleiding o order by o.opl_thema ASC"
    ),
    @NamedQuery(
            name = "Opleiding.getThemas",
            query = ("SELECT distinct o.opl_thema from Opleiding o order by o.opl_thema ASC")
    ),
    @NamedQuery(
            name = "Opleiding.zoekThema",
            query = "select o from Opleiding o where o.opl_thema like :thema"
    ),
    @NamedQuery(
            name = "Opleiding.zoekTitel",
            query = "select o from Opleiding o where o.opl_titel like :titel order by o.opl_thema ASC"
    ),
})
@Entity
